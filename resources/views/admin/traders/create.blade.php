            ...
            <!--begin::Form-->
                <form action="{{route('traders.store')}}" method="post" >
                    ...
                    <div class="card-header mb-3" style="background-color: #0b3251;color: #000000;">
                        <div class="row">
                            <div class="col-md-3">
                                <h4 class="card-title">@lang('app.add_trader')</h4>
                            </div>
                            <div class="col-md-3">
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="mt-4 form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control @error('name')is-invalid @enderror" placeholder=" @lang('app.name')" name="name"/>
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control"  name="type">
                                            ...
                                            <option value="0" {{$trader->type == 0 ? 'selected' : ''}}> @lang('app.mobile_accessories') </option>
                                            <option value="1" {{$trader->type == 1 ? 'selected' : ''}}> @lang('app.mobiles') </option>
